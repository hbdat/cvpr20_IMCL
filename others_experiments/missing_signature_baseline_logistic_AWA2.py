# -*- coding: utf-8 -*-
"""
Created on Mon Sep  3 09:53:28 2018
...
global_setting_AWA2.batch_size=1000
#%% data flag
idx_GPU=1
...
global_setting_AWA2.n_cycles=1000
global_setting_AWA2.signal_strength = 0.5
name = 'missing_signature_balance_'+str(is_balance+0)+'_'+global_setting_AWA2.lr_schedule+'__AWA2_baseline_{}_{}_{}_signal_str_{}_{}_{}_GPU_{}_thresCoeff_{}_stamp_{}'.format(global_setting_AWA2.learning_rate_base,global_setting_AWA2.batch_size,global_setting_AWA2.decay_rate_cond
                                           ,global_setting_AWA2.signal_strength,global_setting_AWA2.n_cycles,n_iters,
                                           idx_GPU,global_setting_AWA2.thresold_coeff,time.time())
save_name = name+'.csv'
...
#%%
#attr_name, class_name = LoadLabelMap(global_setting_AWA2.attr_name_file, global_setting_AWA2.class_name_file)
...
#in memory
dataset_in_1 = tf.data.TFRecordDataset(global_setting_AWA2.record_path)
...
n_experiment= len(global_setting_AWA2.fractions)
...
idx_experiment = 0
for idx_fraction,fraction in enumerate(global_setting_AWA2.fractions):
